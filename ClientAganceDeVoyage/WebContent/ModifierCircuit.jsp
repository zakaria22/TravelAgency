...
try{
	...
	<tr><td>Nom Circuit : </td><td><input type="text" name="nomC" value="<%=C.getNom()%>"></td></tr>
	<tr><td>Descriptif : </td><td><textarea name="desC"><%=C.getDescription()%></textarea></td></tr>
	<tr><td>Duree : </td><td><input type="text" name="dureeC" value="<%=C.getDuree()%>"></td></tr>
<%}catch(NamingException e){e.printStackTrace();}%>
<tr><td><input type="submit" name="modifierC" value="Valider"></td></tr>
</table></div>
<div class="clear">&nbsp;</div>
<p>&nbsp;</p>
<p>&nbsp;</p>
