...
try{
	...
	for(int i=0;i<reservations.size();i++){int cp = 0;if(reservations.get(i).getTypeReserv().equalsIgnoreCase("vol")){%>
	<tr bgcolor="#EBEEEE">
	<td><%out.print(reservations.get(i).getDateReserv());%></td>
	<td><%out.print(reservations.get(i).getVol().getVolG().getAeroportD().getVille().getNomVille()); %></td>
	<td><%out.print(reservations.get(i).getVol().getDateDepart()); %></td>
	<td><%out.print(reservations.get(i).getVol().getVolG().getAeroportA().getVille().getNomVille()); %></td>
	<td><%out.print(reservations.get(i).getVol().getDateDepart()); %></td>
	<%
	...
	%>
	<td><%out.print(cp);%></td>
	<td><a href="detailReserClt.jsp?id=<%=reservations.get(i).getIdRserv() %>" >Detail</a></td>
	</tr>	
	<%}}
