...
<tr><td>Nom du circuit : </td><td><input type="text" name="nomC"></td></tr>
<tr><td>Description du circuit : </td><td><textarea rows="2" cols="50" name="desC"></textarea></td></tr>
<tr><td>Periode du circuit/jour : </td><td><input type="text" name="perC"></td></tr>
<tr><td><input type="submit" name=AddCircuit  value="AddCircuit"></td></tr>
</table>
