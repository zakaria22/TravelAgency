...
try{
	...
	List<InfoEscale> escales = (List)R.getVol().getVolG().getInfoEscaleVolsG();
...
%>
<tr><td bgcolor="#ADB1B1">Compagnie</td><td bgcolor="#91EBE8"><%out.print(R.getVol().getVolG().getCA().getNomA()); %></td></tr>
<tr><td bgcolor="#ADB1B1">Depart du </td><td bgcolor="#91EBE8"><%out.print(R.getVol().getVolG().getAeroportD().getVille().getP().getNomPays()+"-"+R.getVol().getVolG().getAeroportD().getVille().getNomVille()+" ("+R.getVol().getVolG().getAeroportD().getNomA()+")"); %></td></tr>
<tr><td bgcolor="#ADB1B1">Date depart</td><td bgcolor="#91EBE8"><%out.print(R.getVol().getVolG().getJour()+"."+R.getVol().getDateDepart()+"-heure : "+R.getVol().getVolG().getHeureD()); %></td></tr>
<tr><td bgcolor="#ADB1B1">destinataire au</td><td bgcolor="#91EBE8"><%out.print(R.getVol().getVolG().getAeroportA().getVille().getP().getNomPays()+"-"+R.getVol().getVolG().getAeroportA().getVille().getNomVille()+" ("+R.getVol().getVolG().getAeroportA().getNomA()+")"); %></td></tr>
<tr><td bgcolor="#ADB1B1">Date arrivée</td><td bgcolor="#91EBE8"><%out.print(R.getVol().getVolG().getJour()+"."+R.getVol().getDateArrivee()+"-heure : "+R.getVol().getVolG().getHeureA()); %></td></tr>
<%if(escales.size()!=0){%>
<tr><td bgcolor="#ADB1B1">Escale(s)</td><td bgcolor="#91EBE8"><%out.print(escales.size());%></td></tr>
<%} 
else{%>
<tr><td bgcolor="#ADB1B1">Escale(s)</td><td bgcolor="#91EBE8"><%out.print("non");%></td></tr>
<%}%>
</table>
